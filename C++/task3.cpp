...
{
    random_device rd;//random_device to get seed for mt19937
    ...
    mt19937 generator(rd()); // I literally changed this line only 
    uniform_int_distribution<int> distribution(1, 100);// generate random nums from 1 to 100
...
int main()
{
    ...
    cout << "Критическое значение X^2 для 100 элементов " << criticalValue << endl;
    ...
    cout << "Критическое значение X^2 для 1000 элементов " << criticalValue << endl;
